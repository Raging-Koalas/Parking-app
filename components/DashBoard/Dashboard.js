  ...
  return (
    ...
    <div className="flex flex-col">
      ...
      <div className="ml-10 w-[1200px]">
        ...
        <p className="text-xs pl-3 font-normal text-[#848484]">{currentUser?.email}</p>
        </div>
       
        </div>
       <button onClick={handleLogOut} disabled={loading || !currentUser} className="btn btn-primary ">Logout</button>
        </div>
